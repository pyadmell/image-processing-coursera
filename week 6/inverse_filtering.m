...
% Q1: B
% Q2: False
% Q3: 4 mainly high freq
% Q4: uniformly
% Q5: True
% Q6: 22.82 x --> 22.81 x --> 22.92 x
clear all
close all
clc
...
restored_psnr = psnr(original,restored)


%% visualization
figure;
subplot(221); imshow(original, 'border', 'tight');title('original image')
subplot(222); imshow(blurred, 'border', 'tight');title('blurred image')
subplot(223); imshow(noisy, 'border', 'tight');title('noisy image')
subplot(224); imshow(restored, 'border', 'tight');title('restored image')
